...
const parameters = [
  ...
  P('prosody.centroid', 'Спектральный центроид', 'ХРОНОС', 'L1', 'prosodyTool', 'freq', [0, 5000], 'Hz', 'chip'),
  P('prosody.tilt', 'Наклон спектра', 'ХРОНОС', 'L1', 'prosodyTool', 'index', [-60, 60], 'dB/kHz', 'chip'),
  P('prosody.voiced_share', 'Доля вокализованных кадров', 'ХРОНОС', 'L1', 'prosodyTool', 'percent', [0, 100], '%', 'chip'),
  P('prosody.proxy.agitation', 'Прокси: возбуждение/агитация', 'ХРОНОС', 'L1', 'prosodyTool', 'index', [0, 1], 'index', 'chip', '🔵'),
  P('prosody.proxy.flat_affect', 'Прокси: уплощённый аффект', 'ХРОНОС', 'L1', 'prosodyTool', 'index', [0, 1], 'index', 'chip', '🔵'),
  P('prosody.proxy.restraint', 'Прокси: сдержанность', 'ХРОНОС', 'L1', 'prosodyTool', 'index', [0, 1], 'index', 'chip', '🔵'),
  P('lexis.modality_ratio', 'Доля долженствования', 'ЛЕКСИС', 'L1', 'lexisTool', 'index', [0, 1], 'ratio', 'gauge'),
  P('lexis.initiative', 'Инициативность (прокси)', 'ЛЕКСИС', 'L1', 'lexisTool', 'index', [0, 1], 'ratio', 'chip', '🔵'),
  P('lexis.heatmap24', 'Активность по часам', 'ЛЕКСИС', 'L1', 'lexisTool', 'count', [0, 9999], 'n', 'heatmap'),
  P('vaal.ttr', 'TTR', 'VAAL+', 'L1', 'phonoSemTool', 'index', [0, 1], 'ratio', 'chip'),
  P('vaal.hapax', 'Hapax legomena', 'VAAL+', 'L1', 'phonoSemTool', 'index', [0, 1], 'ratio', 'chip'),
  ...['агрессивность', 'тревожность', 'депрессивность', 'демонстративность', 'рациональность', 'эмоциональность', 'социальность', 'витальность'].map((c) => P(`vaal.category.${c}`, `Контент-анализ: ${c} (z)`, 'VAAL+', 'L1', 'phonoSemTool', 'index', [-10, 10], 'z', 'traffic', '🔵')),
  ...['светлый', 'тёмный', 'весёлый', 'печальный', 'красивый', 'сложный'].map((b) => P(`belyanin.${b}`, `Белянин: ${b}`, 'Белянин', 'L1', 'phonoSemTool', 'index', [0, 1], 'share', 'chip', '🔵')),
  P('czi8.liberty_mode', 'Модус свободы воли А/Б/В/Г', 'ЦЗИ-8', 'L1', 'groundingClassifier', 'enum', [0, 3], 'mode', 'chip', '🔵'),
  P('clinic.scl90_gsi', 'SCL-90-R GSI', 'Клиника', 'L1', 'scaleScorer', 'index', [0, 4], 'index', 'traffic'),
  P('clinic.mbi_dp', 'MBI деперсонализация', 'Маслач', 'L1', 'scaleScorer', 'score', [0, 30], 'балл', 'traffic'),
  P('clinic.mbi_pa', 'MBI личные достижения', 'Маслач', 'L1', 'scaleScorer', 'score', [0, 48], 'балл', 'traffic'),
